...
class AudioConverter:
    ...
    def convert(self, 
        ...
        try:
            ...
            self.logger.error(f"Error convirtiendo {input_path}: {str(e)}")
            return False
    ...
    def _convert_with_librosa(self, 
        ...
        try:
            ...
            self.logger.error(f"Error en conversión con librosa: {str(e)}")
            return False
    ...
    def _convert_with_pydub(self, 
        ...
        try:
            ...
            self.logger.error(f"Error en conversión con pydub: {str(e)}")
            return False
    ...
    def get_audio_info(self, file_path: Union[str, Path]) -> Optional[dict]:
        ...
        try:
            ...
            self.logger.error(f"Error obteniendo info de {file_path}: {str(e)}")
            return None
